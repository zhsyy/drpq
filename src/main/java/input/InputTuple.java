...
//        h = (int) (31 * h + timestamp);
        return h;
    }

    @Override
    public String toString() {
        return "<" + this.source + "," + this.target + "," + this.label + ", " + this.timestamp + ">";
    }
...
//    public boolean isInitialEdge() {
//        return isInitialEdge;
//    }

    public void setInitialEdge(boolean initialEdge) {
        isInitialEdge = initialEdge;
    }
